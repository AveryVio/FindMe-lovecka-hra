...
set(FindMe_default_default_XC32_FILE_TYPE_assemble)
set(FindMe_default_default_XC32_FILE_TYPE_assembleWithPreprocess)
set_source_files_properties(${FindMe_default_default_XC32_FILE_TYPE_assembleWithPreprocess} PROPERTIES LANGUAGE C)
set(FindMe_default_default_XC32_FILE_TYPE_compile
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/app_ble/app_pxpr_handler.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/config/default/ble/profile_ble/ble_pxpr/ble_pxpr.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/config/default/ble/service_ble/ble_ias/ble_ias.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/config/default/ble/service_ble/ble_lls/ble_lls.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/config/default/ble/service_ble/ble_tps/ble_tps.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/dilithium.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/ext_kyber.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/ext_lms.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/ext_xmss.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/hpke.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sm2.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sm3.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sm4.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sp_sm2_arm32.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sp_sm2_arm64.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sp_sm2_armthumb.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sp_sm2_c32.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sp_sm2_c64.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sp_sm2_cortexm.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sp_sm2_x86_64.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sp_x86_64.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/sphincs.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/wc_kyber.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/wc_kyber_poly.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/wc_lms.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/wc_lms_impl.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/wc_xmss.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/third_party/wolfssl/wolfssl/wolfcrypt/src/wc_xmss_impl.c"
...
set(FindMe_default_default_XC32_FILE_TYPE_compile_cpp)
set(FindMe_default_default_XC32_FILE_TYPE_link)

# The linker script used for the build.
set(FindMe_default_LINKER_SCRIPT "${CMAKE_CURRENT_SOURCE_DIR}/../../../src/config/default/WBZ451.ld")

# The (internal) path to the resulting build image.
set(FindMe_default_internal_image_name "${CMAKE_CURRENT_SOURCE_DIR}/../../../_build/FindMe/default/default.elf")

# The name of the resulting image, including namespace for configuration.
set(FindMe_default_image_name "FindMe_default_default.elf")

# The name of the image, excluding the namespace for configuration.
set(FindMe_default_original_image_name "default.elf")

# The output directory of the final image.
set(FindMe_default_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/FindMe")
