...
set(MP_CC_DIR "D:/program files/Microchip/xc32/v4.45" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler base directory")
set(CMAKE_C_COMPILER "D:/program files/Microchip/xc32/v4.45/bin/xc32-gcc.exe" CACHE FILEPATH "Path to the compiler binary")
...
set(CMAKE_CXX_COMPILER "D:/program files/Microchip/xc32/v4.45/bin/xc32-g++.exe" CACHE FILEPATH "Path to the compiler binary.")
...
set(CMAKE_ASM_COMPILER "D:/program files/Microchip/xc32/v4.45/bin/xc32-gcc.exe" CACHE FILEPATH "Path to the compiler binary.")

# Legacy variable from MPLAB X pointing to the assembler binary.
set(MP_AS ${CMAKE_ASM_COMPILER})

set(MP_LD "D:/program files/Microchip/xc32/v4.45/bin/xc32-ld.exe" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the linker binary.")

set(MP_BIN2HEX "D:/program files/Microchip/xc32/v4.45/bin/xc32-bin2hex.exe" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the bin2hex binary.")
